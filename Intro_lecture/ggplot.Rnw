...
iris[1:2, ]
# Note the use of the '.' function to allow group and sex to be used without quoting
ddply(iris, .(Species), summarize, mean_Sepal.Width = mean(Sepal.Width, na.rm = TRUE))
